                ...
                @forelse ($equipos as $equipo)
                    ...
                    <tr class="
                        ...
                        <td class="px-4 py-3 align-top text-right whitespace-nowrap">
                            ...
                            @php
                                $user = auth()->user();
                                $puedeVerResumen = $user && $user->tienePermiso('prep.equipos.ver');
                            @endphp
...
<div
    ...
    wire:keydown.escape.window="cerrarResumen"
>
    {{-- overlay --}}
    <button
        type="button"
...
<div class="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
    ...
    <div class="bg-slate-900 rounded-2xl border border-white/10
                w-full max-w-4xl p-6 text-white relative">
        ...
        <h2 class="text-lg font-bold mb-6 text-[#FF9521]">
            Comparación de equipos seleccionados
        </h2>
        ...
        @foreach($comparacionResumen as $campo => $valores)
            ...
            <div class="mb-6">
                ...
                <h3 class="text-sm uppercase tracking-wider mb-3 text-[#FF9521] font-semibold">
                    {{ $campo }}
                </h3>
                            ...
                            @if($data['diferente'])
                                <details class="mt-2 text-xs text-gray-300">
                                    <summary class="cursor-pointer text-red-400">
                                        Ver equipo(s) diferente(s)
                                    </summary>

                                    <div class="mt-2 space-y-1">
                                        @foreach($data['equipos'] as $serie)
                                            <div>• Serie: {{ $serie }}</div>
                                        @endforeach
                                    </div>
                                </details>
