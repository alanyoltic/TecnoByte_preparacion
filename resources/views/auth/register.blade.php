        ...
        <div class="w-full px-4 sm:px-6 lg:px-8">
            ...
            >
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                    ...
                    {{-- Podrías usar esto después para mostrar rol por defecto o algo similar --}}
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-[0.7rem] font-medium
                                 bg-slate-100/80 dark:bg-slate-800/80
                                 text-slate-600 dark:text-slate-300 border border-slate-200/80 dark:border-slate-700/80">
                        Nuevo registro
                    </span>
                </div>
