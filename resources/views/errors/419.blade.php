...
<head>
  ...
  <title>TecnoByte | Sesión expirada (419)</title>
...
<body>
  ...
  <div class="wrap">
    ...
    <div class="card">
      <div class="topbar">
        <div class="status"><span class="dot"></span> Token inválido</div>
        <div class="pill">419</div>
      </div>
      ...
      <div class="content">
        ...
        <p class="txt">
          Por seguridad, tu sesión o token CSRF ya no es válido.<br>
          Refresca la página e intenta de nuevo.
        </p>

        <div class="actions">
          <a class="btn" href="{{ url()->previous() }}">Volver</a>
          <a class="btn btnPrimary" href="{{ route('login') }}">Iniciar sesión</a>
        </div>
      </div>
    ...
    <div class="below">Tip: si estabas llenando un formulario, recarga y vuelve a enviarlo.</div>
  </div>
</body>
</html>
