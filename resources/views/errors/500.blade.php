...
<head>
  ...
  <title>TecnoByte | Error 500</title>
  ...
  <style>
    :root{
      ...
      --danger: rgba(248,113,113,.24);
      --danger2: rgba(248,113,113,.12);
    }
    *{box-sizing:border-box}
    ...
    .badge2 .dot2{
      width:8px; height:8px; border-radius:999px;
      background: rgba(255,149,33,.95);
      box-shadow: 0 0 16px rgba(255,149,33,.45);
...
<body>
  ...
  <div class="wrap">
    <div class="brand">
      ...
      <h1>TecnoByte</h1>
      <p>Error interno del sistema</p>
    </div>

    <div class="card">
      <div class="topbar">
        <div class="status"><span class="dot"></span> Incidente detectado</div>
        <div class="pill">Error 500</div>
      </div>
      ...
      <div class="content">
        <div class="badgeIcon" aria-hidden="true">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round"
              d="M12 9v3m0 4h.01M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0Z"/>
          </svg>
        </div>

        <h2>Algo no salió como esperábamos</h2>
        <p class="txt">
          Ocurrió un problema inesperado mientras se procesaba tu solicitud.<br>
        ...
        <div class="actions">
          ...
          {{-- Si tu dashboard route puede fallar en algunas ocasiones, este botón seguirá siendo opcional --}}
          <a class="btn btnPrimary" href="{{ route('dashboard') }}">Intentar de nuevo</a>
        </div>

        <div class="badge2">
          <span class="dot2"></span> El sistema registró el incidente automáticamente
        </div>
      </div>
    ...
    <div class="below">Si el problema persiste, contacta a un administrador.</div>
  </div>
