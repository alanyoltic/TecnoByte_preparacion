...
<head>
  ...
  <title>TecnoByte | No encontrado (404)</title>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .pill{
      ...
      color: var(--orange);
      background: rgba(255,149,33,.12);
      border: 1px solid rgba(255,149,33,.30);
    }
    .status{display:flex; align-items:center; gap:8px; font-size:12px; color: var(--muted);}
    .dot{width:8px; height:8px; border-radius:999px; background: var(--orange); box-shadow: 0 0 18px rgba(255,149,33,.65); animation: pulse 1.2s infinite;}
    ...
    .badgeIcon svg{position:relative; width:26px; height:26px; color: rgba(255,149,33,.95);}
    ...
    .btnPrimary{border-color: rgba(255,149,33,.30); background: rgba(255,149,33,.10);}
    .btnPrimary:hover{background: rgba(255,149,33,.14); border-color: rgba(255,149,33,.38);}
...
<body>
  ...
  <div class="wrap">
    ...
    <div class="card">
      <div class="topbar">
        <div class="status"><span class="dot"></span> Ruta inválida</div>
      ...
      <div class="content">
        <div class="badgeIcon" aria-hidden="true">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M10 6H5a2 2 0 0 0-2 2v11a2 2 0 0 0 2 2h11a2 2 0 0 0 2-2v-5"/>
            <path stroke-linecap="round" stroke-linejoin="round" d="M14 3h7v7"/>
            <path stroke-linecap="round" stroke-linejoin="round" d="M21 3L10 14"/>
          </svg>
        </div>

        <h2>Esta página no existe</h2>
        <p class="txt">
          La ruta a la que intentaste acceder no está disponible o fue movida.<br>
          Verifica la URL o regresa al inicio.
        </p>

        <div class="actions">
          <a class="btn" href="{{ url()->previous() }}">Volver</a>
          <a class="btn btnPrimary" href="{{ route('dashboard') }}">Inicio</a>
        </div>
      </div>
    ...
    <div class="below">Si llegaste aquí desde un botón del sistema, avisa a un administrador.</div>
  </div>
</body>
</html>
